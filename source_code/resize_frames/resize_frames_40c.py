...
data = 'train'
if not os.path.exists('/Users/ramkishore31/PycharmProjects/detect_sport_video/' + data + '_frame_resize3/'):
    os.makedirs('/Users/ramkishore31/PycharmProjects/detect_sport_video/' + data + '_frame_resize3/')
...
for video in video_list:
    ...
    if not os.path.exists('/Users/ramkishore31/PycharmProjects/detect_sport_video/' + data + '_frame_resize3/' + video + '/'):
        os.makedirs('/Users/ramkishore31/PycharmProjects/detect_sport_video/' + data + '_frame_resize3/' + video + '/')
    for frame in frame_list:
        if frame != ".DS_Store":
            if os.stat('/Users/ramkishore31/PycharmProjects/detect_sport_video/' + data + '_frame_videos2/' + video + '/' + frame).st_size > 0:
                ...
                image.save('/Users/ramkishore31/PycharmProjects/detect_sport_video/' + data + '_frame_resize3/' + video + '/' + frame, quality=100)
